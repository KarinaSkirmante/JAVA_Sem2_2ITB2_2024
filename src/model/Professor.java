...
public class Professor extends Person{
	...
	//3. constructors
	public Professor() {
		super();//te tiks izsaukts Person() konstruktors
		setpID();
		setDegree(Degree.other);
	}

	public Professor(String name, String surname, 
			Degree degree, String personCode) {
		super(name, surname, personCode);//te tiek izsaukts Person(String name, String surname, String personCode)  konstruktors
		setpID();
		setDegree(degree);
	}
